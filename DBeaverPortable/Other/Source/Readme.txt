...
user in an INI file next to DBeaverPortable.exe called DBeaverPortable.ini.
...
copy AppNamePortable.ini from this directory to DBeaverPortable.ini next to
DBeaverPortable.exe. The options in the INI file are as follows:
